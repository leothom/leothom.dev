...
export default async function Home() {
  ...
  return (
    <div className="text-gray-700 dark:text-gray-200">
      ...
      <p className='mt-6 text-xl'><FontAwesomeIcon icon={faCodeBranch} className="text-gray-600 dark:text-gray-300 mr-2" /><Link href="https://github.com/leothom/leothom.dev" target="_blank" className='hover:text-gray-900 hover:underline underline'>GitHub Repo for this website</Link></p>
