...
async function ProjectGrid() {
  ...
  return (
    <>
      <h1 className='text-4xl sm:text-7xl font-extrabold bg-gradient-to-r from-orange-400 via-red-600 to-purple-500 dark:from-blue-700 dark:via-gray-500 dark:to-white bg-clip-text text-transparent md:py-10 py-5'>Projects</h1>
